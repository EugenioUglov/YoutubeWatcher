document.addEventListener('DOMContentLoaded', function(){
	...
	function doWithSpeechMainFunc(speech_text){
	  ...
	  if(selected_language_user === "English"){
		...
		else if(speech_text.includes("background")){

				// Check all colors in list 
		  colors_list_en.forEach(color_element_en => {
			if(speech_text.includes(color_element_en)){
			  document.body.style.background = color_element_en;
			  return;
			}
		  });

		  if(speech_text.includes("black")){
			document.body.style.background = "black";
		  }
		  else if(speech_text.includes("white"))
		  {
	  ...
	  // RUSSIAN
		...
		else if(speech_text.includes("фон")){
		  
		  // Check all colors in list 
		  colors_keyList_ru.forEach(color_element_ru => {
			if(speech_text.includes(color_element_ru)){
			  document.body.style.background = colors_ru[color_element_ru];
			  return;
			}
		  });
		}
